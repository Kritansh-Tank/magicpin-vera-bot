...
# Your API key — set via environment variable: $env:GROQ_API_KEY="your-key"
# Or paste directly here for local testing (do NOT commit with real key)
LLM_API_KEY = os.environ.get("GROQ_API_KEY", "")  # <-- set env var or paste key here
